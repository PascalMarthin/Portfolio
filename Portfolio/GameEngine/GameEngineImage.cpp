...
//////////////////////////////////////////////////////////////////////// Trans
void GameEngineImage::TransCopy(GameEngineImage* _Other, const float4& _CopyPos, unsigned int _TransColor)
{
	TransCopy(_Other, _CopyPos - _Other->GetScale().Half(), _Other->GetScale(), float4{ 0, 0 }, _Other->GetScale(), _TransColor);
}
void GameEngineImage::TransCopy(GameEngineImage* _Other, const float4& _CopyPos, const float4& _RenderScale, unsigned int _TransColor)
{
	...
	const float4& _OtherPivot, const float4& _OtherScale, unsigned int _TransColor)
{
	...
	TransparentBlt(
		...
		_OtherPivot.ix(), // 복사하려는 대상의 시작점X
		_OtherPivot.iy(),// 복사하려는 대상의 시작점Y
		_OtherScale.ix(), // 복사하려는 대상의 끝점X
		_OtherScale.iy(),// 복사하려는 대상의 끝점Y
