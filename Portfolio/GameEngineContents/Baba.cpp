...
void Baba_Unit::SettingAbility()
{
	...
	AnimationTake_["Baba_Unit_Up"].push_back(std::make_pair(24, 26));
	AnimationTake_["Baba_Unit_Left"].push_back(std::make_pair(30, 32));
	AnimationTake_["Baba_Unit_Left"].push_back(std::make_pair(33, 35));
	AnimationTake_["Baba_Unit_Left"].push_back(std::make_pair(36, 38));
	AnimationTake_["Baba_Unit_Left"].push_back(std::make_pair(39, 41));
	AnimationTake_["Baba_Unit_Down"].push_back(std::make_pair(45, 47));
	AnimationTake_["Baba_Unit_Down"].push_back(std::make_pair(48, 50));
	AnimationTake_["Baba_Unit_Down"].push_back(std::make_pair(51, 53));
	AnimationTake_["Baba_Unit_Down"].push_back(std::make_pair(54, 56));
